...
Covers the construction, assignment, reading, and clearing of `Task.RepetitionRule` values on OmniFocus tasks. Individual tools will be defined in the `recurrence` change.
